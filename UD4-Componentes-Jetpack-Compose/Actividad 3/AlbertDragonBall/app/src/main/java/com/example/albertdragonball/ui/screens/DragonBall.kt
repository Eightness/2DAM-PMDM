...
fun DragonBall() {
    ...
    //Variable that contains all characters
    val dragonBallCharacters: List<String> = listOf("Goku", "Vegeta", "Piccolo", "Gohan", "Frieza")
    ...
    if (showDialog) {
        AlertDialog(onDismissRequest = {
            ...
            Image(painter = painterResource(id = R.drawable.dragonball_logo), contentDescription = "jaja")
        }, confirmButton = {
